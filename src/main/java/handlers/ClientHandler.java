...
public class ClientHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        // GET /clients/upcoming-deadlines?days=N
        if ("GET".equals(method) && path.equals("/clients/upcoming-deadlines")) {
            controller.findByUpcomingDeadline(exchange);
            return;
        }

        String id = HttpUtils.extractId(path, "/clients");
